...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1266015312ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slidemedb&table=appinfos">`slidemedb`.`appinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slidemedb&table=gameurlandname">`slidemedb`.`gameurlandname`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=giantbomb&table=gameinfos">`giantbomb`.`gameinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=giantbomb&table=gameids">`giantbomb`.`gameids`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=steamgameurlsandtitles">`gamesdb`.`steamgameurlsandtitles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=steamgametagurls">`gamesdb`.`steamgametagurls`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=gameinfos">`gamesdb`.`gameinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yii2basic&table=country">`yii2basic`.`country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=performance_schema&table=accounts">`performance_schema`.`accounts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">USE `test`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="giantbomb" targettable="gameids">
                            <div class="action_content">
